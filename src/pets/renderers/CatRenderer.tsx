...
/**
 * The SVG-Repo green-eyed cat. Paths from the user's curated SVG, with
 * part-based idle animation (blink, breathe, tail sway). Moving/sleeping
 * animations arrive in later chunks.
 */
function CatRenderer({ state }: RendererProps) {
  const { size, action } = state;
  return (
    <svg
      className={`svgcat svgcat-${action}`}
      width={size}
      height={size}
      viewBox="0 0 64 64"
    ...
    >
      ...
      <path className="sc-leye" d="M33.5 28.5s-2.4 3.6-6.8 2.5s-4.6-5.4-4.6-5.4s2.4-3.6 6.8-2.5c4.4 1.2 4.6 5.4 4.6 5.4" fill="#bfffab" />
      <path d="M33 26.7S30.9 29 28 29c-3.1 0-5-4.4-5-4.4s2.1-2.4 5.8-1.4c3.5.8 4.2 3.5 4.2 3.5" fill="#93e67f" />
      <path className="sc-lpupil" d="M29.8 26.6c0 4.9-2.4 4.9-2.4 0s2.4-4.9 2.4 0" fill="#4c5359" />
      <path className="sc-reye" d="M45.1 28.5s2.4 3.6 6.8 2.5s4.6-5.4 4.6-5.4s-2.4-3.6-6.8-2.5c-4.4 1.2-4.6 5.4-4.6 5.4" fill="#bfffab" />
      <path d="M45.5 26.7s2.1 2.3 5 2.3c3.1 0 5-4.4 5-4.4s-2.1-2.4-5.8-1.4c-3.5.8-4.2 3.5-4.2 3.5" fill="#93e67f" />
      <path className="sc-rpupil" d="M48.7 26.6c0 4.9 2.4 4.9 2.4 0c.1-4.9-2.4-4.9-2.4 0" fill="#4c5359" />
